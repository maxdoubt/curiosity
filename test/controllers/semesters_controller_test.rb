...
class SemestersControllerTest < ActionController::TestCase
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post :create, semester: { begin_date: @semester.begin_date, end_date: @semester.end_date, name: @semester.name }
    end
  ...
  test "should update semester" do
    patch :update, id: @semester, semester: { begin_date: @semester.begin_date, end_date: @semester.end_date, name: @semester.name }
    assert_redirected_to semester_path(assigns(:semester))
  end
